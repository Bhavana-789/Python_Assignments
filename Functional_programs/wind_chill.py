def wind_chill(t, v):
    ...
    :param t: to get temperature value in fahrenheit
    :param v: to get wind speed in mile per hour
    ...
    if t <= 50 and (v <= 120 or v >= 3):
        ...
        print("Required Temperature value is larger than 50 and wind speed is more than 120 or less than 3")
